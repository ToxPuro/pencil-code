...
!$omp threadprivate(nbvec,eta_rwidth,eta_rwidth0,eta_rwidth1,eta_r,geta_r,va2max_beta,etatotal,eta_smag,&
!$omp Fmax,dAmax,ss0,diffus_eta,diffus_eta2,diffus_eta3,advec_va2,fres)
  contains
!***********************************************************************
