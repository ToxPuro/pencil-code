...
real, dimension(nx) :: dt1_drag = 0.0
real, dimension(3) :: adv_der_uup = 0.0
real :: added_mass_beta = 0.0
logical :: nochange=.true.
!
!$omp threadprivate(uup_shared,vel_call, dt1_drag, adv_der_uup, added_mass_beta, nochange)
!$omp threadprivate(eps1, ifgx, ifgy, ifgz)
contains
!***********************************************************************
